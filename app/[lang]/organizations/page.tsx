...
import { CreateOrganizationDialog } from "./components/organization-dialog"
import {
  OrganizationsClient,
  OrganizationsCount,
} from "./components/organizations-client"
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-[13px] text-text-muted">
              {t("organizations.countBefore")}
              <OrganizationsCount />
              {t("organizations.countAfter")}
            </p>
          </div>
