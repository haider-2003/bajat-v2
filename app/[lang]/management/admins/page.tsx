...
import { CreateAdminDialog } from "./components/admin-dialog"
import { AdminsClient, AdminsCount } from "./components/admins-client"

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations()
  return { title: t("admins.metaTitle") }
}
