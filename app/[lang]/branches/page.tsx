...
import { BranchesClient, BranchesCount } from "./components/branches-client"
import { CreateBranchDialog } from "./components/branch-dialog"

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations()
  return { title: t("branches.metaTitle") }
}
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-[13px] text-text-muted">
              {t("branches.countBefore")}
              <BranchesCount />
              {t("branches.countAfter")}
            </p>
          </div>
