      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            {/* The count is a live client component, so the sentence is split
                around it rather than interpolated: `t()` returns a string, and
                a string cannot hold a React element. Both halves are their own
                dictionary entries so a translator can put the number where the
                language wants it. */}
            <p className="mt-1 text-[13px] text-text-muted">
              {t("members.countBefore")}
              <MembersCount />
              {t("members.countAfter")}
            </p>
          </div>
