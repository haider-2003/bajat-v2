...
const POINTS = [
  { icon: IdCard, label: "Design and issue ID card templates" },
  { icon: Workflow, label: "Route requests through your branches" },
  { icon: ShieldCheck, label: "Permission-scoped, audited access" },
]
    ...
    <div className="relative hidden overflow-hidden bg-[#080d16] lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      <div className="relative">
        <p className="max-w-sm text-xl font-semibold leading-snug tracking-[-0.015em] text-white">
          One system for every identity your organization issues.
        </p>
